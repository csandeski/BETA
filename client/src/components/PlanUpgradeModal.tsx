...
import { X, Check, Shield, Lock, TrendingUp, Zap, Award, ChevronRight, ArrowRight, DollarSign, Clock, Users, Star, Infinity, Trophy, AlertTriangle, TrendingDown, Hand, Info, Headphones, Book, CheckCircle, QrCode } from "lucide-react";
...
export function PlanUpgradeModal({ isOpen, onClose, totalEarned = 0, onUpgrade, isDiscounted = false }: PlanUpgradeModalProps) {
  ...
  // Removed form fields and PIX data - these are now handled in the payment page
  ...
  // Track InitiateCheckout will be done on the payment page instead
  ...
  const handleUpgrade = async () => {
    ...
    onClose();
    setLocation(`/payment?plan=${selectedPlan}`);
  };
  
  // Payment functions moved to payment page
  
  // PIX generation moved to payment page
  
  // Copy function moved to payment page
  
  // Format function moved to payment page
  
  // Price calculation moved to payment page
            ...
            <>
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-600">
                  ...
                  {step === 4 && "Ative agora e comece a ganhar mais"}
                </p>
              </div>
