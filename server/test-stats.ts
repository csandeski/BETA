...
import { users, userStats, booksCompleted, transactions } from '../shared/schema';
...
async function testStats() {
  ...
  try {
    ...
    const db = getDb(); // Obter a instância do database
    ...
    for (const user of allUsers) {
      ...
      if (stats) {
        ...
        console.log(`   Estatísticas criadas com sucesso:`, newStats.id);
      }
